...
.data
    ...
    Values_B dd 5, 17, -7, 10, -15
    Values_C dd 6, 3, 27, -4, 1
...
.repeat 
    ...
    ; Compute the denominator: 41 - b*a + c
    mov edi, 41
    imul ebx, eax ; b*a
    sub edi, ebx  ; 41 - b*a
    add edi, ecx  ; + c
